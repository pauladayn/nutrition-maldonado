...
export const plans = [
    {
        ...
        mainInfo: 'Este plan es ideal para comenzar un cambio de hábitos. Está pensado para que lo hagas al menos durante 4 semanas y cuando te sientas seguro puedas avanzar un paso más y adquirir el plan Personalizado.',
        path: '/planes',
        bg: 'peach',
        img: card04,
    },
