const Cards = () => {
  return (
    <div className='block rounded-3xl bg-white shadow-xl dark:bg-neutral-700 text-center max-w-xs'>
      <div className='p-6'>
        ...
        <p className='mb-2 text-base text-neutral-500 dark:text-neutral-300'>
          Explore the captivating beauty of Antelope Canyons red sandstone
